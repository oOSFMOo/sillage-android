...
class MainActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val sillagePreferences = getSharedPreferences("sillage", MODE_PRIVATE)
        if (!sillagePreferences.getBoolean("french-default", false)) {
            sillagePreferences.edit().putBoolean("french-default", true).apply()
